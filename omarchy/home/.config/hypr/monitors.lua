...
-- through the built-in HDMI port, center it above the laptop display.
hl.monitor({ output = "eDP-1", mode = "3456x2234@120", position = "0x0", scale = 2 })
hl.monitor({ output = "HDMI-A-1", mode = "preferred", position = "auto-center-up", scale = "auto" })
